...
export default async function TimetablePage({ searchParams }: { searchParams: Promise<{ ok?: string; error?: string }> }) {
  ...
  return <AdminShell page="timetable" username={session.username} title="Timetable" description="Configure the school-wide periods used to turn block rotation letters into a daily schedule." notice={params}>
