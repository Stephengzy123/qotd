...
export function AdminEntryFields({ idPrefix, announcementMinimumDate, eventMinimumDate, initialType = "announcement", initialTitle = "", initialDate, initialAnnouncement = "", initialDaysEarly = 0 }: AdminEntryFieldsProps) {
