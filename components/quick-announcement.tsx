  ...
  return <section aria-label="Quick announcement" className={compact ? "quick-announcement live-compose" : "panel quick-announcement"}>{!compact && <h2>Quick announcement</h2>}
    <form action={action} onSubmit={event => {
      ...
      <fieldset disabled={pending}>
        ...
        <details open={compact ? undefined : true}><summary>Preview</summary><div className="discord-preview"><div className="quick-identity">{avatarUrl && <img src={avatarUrl} alt="" width={32} height={32} />}<strong>{nickname.trim() || "Nickname"}</strong><small>BOT</small></div><DiscordMarkdown value={preview} /></div></details>
